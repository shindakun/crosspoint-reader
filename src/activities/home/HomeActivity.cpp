...
int HomeActivity::getMenuItemCount() const {
  int count = 5;  // My Library, Recents, File transfer, Deep Mines, Settings
...
void HomeActivity::render() {
  ...
  std::vector<const char*> menuItems = {"Browse Files", "Recents", "File Transfer", "Deep Mines", "Settings"};
  if (hasOpdsUrl) {
